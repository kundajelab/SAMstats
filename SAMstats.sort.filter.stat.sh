...
#unique on the read names 
samtools view $sorted_bam | sort -u -k1,1 - | samtools view -S -b -  > $sorted_bam.uniq
...
qcPassed=`samtools view -F 0x200 $sorted_bam.uniq | cut -f1 | uniq | wc -l` 
echo "qcPassed:$qcPassed"
qcFailed=`samtools view -f 0x200 $sorted_bam.uniq | cut -f1 | uniq | wc -l` 
echo "qcFailed:$qcFailed"

#secondary, 0x100 bit set 
secondary_qcPassed=`samtools view -F 0x200 -f 0x100 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "secondary_qcPassed:$secondary_qcPassed"
secondary_qcFailed=`samtools view -f 0x200 -f 0x100 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "secondary_qcFailed:$secondary_qcFailed"

#supplementary, 0x800 bit set 
supplementary_qcPassed=`samtools view -F 0x200 -f 0x800 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "supplementary_qcPassed:$supplementary_qcPassed"
supplementary_qcFailed=`samtools view -f 0x200 -f 0x800 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "supplementary_qcFailed:$supplementary_qcFailed"


#duplicates,0x400 bit set
duplicates_qcPassed=`samtools view -F 0x200 -f 0x400 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "duplicates_qcPassed:$duplicates_qcPassed"
duplicates_qcFailed=`samtools view -f 0x200 -f 0x400 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "duplicates_qcFailed:$duplicates_qcFailed"

#mapped, 0x4 bit not set
mapped_qcPassed=`samtools view -F 0x200 -F 0x4 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "mapped_qcPassed:$mapped_qcPassed"
mapped_qcFailed=`samtools view -f 0x200 -F 0x4 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "mapped_qcFailed:$mapped_qcFailed"

#paired in sequencing, 0x1 bit set
pairedInSequencing_qcPassed=`samtools view -F 0x200 -f 0x1 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "pairedInSequencing_qcPassed:$pairedInSequencing_qcPassed"
pairedInSequencing_qcFailed=`samtools view -f 0x200 -f 0x1 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "pairedInSequencing_qcFailed:$pairedInSequencing_qcFailed"

#read1, both 0x1 and 0x40 bits set
read1_qcPassed=`samtools view -F 0x200 -f 0x1 -f 0x40 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "read1_qcPassed:$read1_qcPassed"
read1_qcFailed=`samtools view -f 0x200 -f 0x1 -f 0x40 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "read1_qcFailed:$read1_qcFailed"

#read2, both 0x1 and 0x80 bits set
read2_qcPassed=`samtools view -F 0x200 -f 0x1 -f 0x80 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "read2_qcPassed:$read2_qcPassed"
read2_qcFailed=`samtools view -f 0x200 -f 0x1 -f 0x80 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "read2_qcFailed:$read2_qcFailed"

#properly paired, both 0x1 and 0x2 bits set and 0x4 bit not set
properlyPaired_qcPassed=`samtools view -F 0x200 -f 0x1 -f 0x2 -F 0x4 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "properlyPaired_qcPassed:$properlyPaired_qcPassed"
properlyPaired_qcFailed=`samtools view -f 0x200 -f 0x1 -f 0x2 -F 0x4 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
...
withItselfAndMateMapped_qcPassed=`samtools view -F 0x200 -f 0x1 -F 0x4 -F 0x8 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "withItselfAndMateMapped_qcPassed:$withItselfAndMateMapped_qcPassed"
withItselfAndMateMapped_qcFailed=`samtools view -f 0x200 -f 0x1 -F 0x4 -F 0x8 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
...
singletons_qcPassed=`samtools view -F 0x200 -f 0x1 -f 0x8 -F 0x4 $sorted_bam.uniq | cut -f1 | uniq | wc -l `
echo "singletons_qcPassed:$singletons_qcPassed"
singletons_qcFailed=`samtools view -f 0x200 -f 0x1 -f 0x8 -F 0x4  $sorted_bam.uniq | cut -f1 | uniq | wc -l `
...
withMateMappedToDiffChrom_qcPassed=`samtools view -F 0x200 -f 0x1 -F 0x4 -F 0x8 $sorted_bam.uniq |awk '{ if ($7 == "=") { print } }'| cut -f1 | uniq | wc -l `
echo "withMateMappedToDiffChrom_qcPassed:$withMateMappedToDiffChrom_qcPassed"
withMateMappedToDiffChrom_qcFailed=`samtools view -f 0x200 -f 0x1 -F 0x4 -F 0x8 $sorted_bam.uniq |awk '{ if ($7 == "=") { print } }'| cut -f1 | uniq | wc -l `
...
withMateMappedToDiffChromQC5_qcPassed=`samtools view -F 0x200 -F 0x4 -q5 $sorted_bam.uniq | awk '{ if ($7 == "=") { print } }'|cut -f1 | uniq | wc -l `
echo "withMateMappedToDiffChromQC5_qcPassed:$withMateMappedToDiffChromQC5_qcPassed"
withMateMappedToDiffChromQC5_qcFailed=`samtools view -f 0x200 -F 0x4 -q5 $sorted_bam.uniq | awk '{ if ($7 == "=") { print } }'|cut -f1 | uniq | wc -l `
...
then 
    ...
    percent_properlyPaired_qcPassed=`echo $multiplier*$properlyPaired_qcPassed/$qcPassed|bc -l`
    percent_singletons_qcPassed=`echo $multiplier*$singletons_qcPassed/$qcPassed|bc -l`
fi
if (($qcFailed == 0))
then 
    ...
    percent_properlyPaired_qcFailed=`echo $multiplier*$properlyPaired_qcFailed/$qcFailed|bc -l`
    percent_singletons_qcFailed=`echo $multiplier*$singletons_qcFailed/$qcFailed|bc -l`
fi
